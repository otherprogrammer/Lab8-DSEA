...
namespace Lab08_MattiasMarquez.Models;

public partial class Lab08DbContext : DbContext
{
    public Lab08DbContext()
    {
    }

    public Lab08DbContext(DbContextOptions<Lab08DbContext> options)
        : base(options)
    {
    }
